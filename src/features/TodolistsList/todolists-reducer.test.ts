...
test('correct todolist should be removed', () => {
    const endState = todolistsReducer(startState, todolistsThunks.removeTodolist.fulfilled({id: todolistId1}, 'requestId', {todolistId: "todolistId2"}))
...
test('correct todolist should be added', () => {
    ...
    const endState = todolistsReducer(startState, todolistsThunks.addTodolist.fulfilled({todolist}, 'requestId', {title: todolist.title}))
